...
def _build_faster_rcnn_feature_extractor(feature_extractor_config, 
  is_training, num_input_channels=3, reuse_weights=None, inplace_batchnorm_update=False):
  ...
  return feature_extractor_class(
      ...
      num_input_channels, batch_norm_trainable, reuse_weights)
